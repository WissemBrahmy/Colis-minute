        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="ServletSite?gerer=Vcomptes"><i class="fa fa-circle-o"></i> Valider Annonces</a></li>
                <li><a href="ServletSite?gerer=lstComptes"><i class="fa fa-circle-o"></i> Liste Annonces </a></li>
              </ul>
            </li>
			 <li class="treeview">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>${A.datearriv}</td>
                         ...
                         <td>${A.etat}</td>
                        <td> 
                        <a href="ServletSite?gerer=deleteAnn&idd=${A.id }"><button type="submit" class="btn btn-info">Supprimer</button></a>
						</td>
                      </tr>
                      </c:forEach>

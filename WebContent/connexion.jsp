    ...
    <body>
		...
		<div class="container">
                <div class="row page-title text-center  wow bounce"  data-wow-delay=".7s">
                    ...
                    <h4>Vous devez se connecter d'abord</h4>
                </div>
                <div class="row testimonial">
                    <div class="col-md-4">
                        <div id="testimonial-slider">
                              <form role="form" action="ServletSite" method="post">
                                      <h3><font color="#00aeef">Connexion</font></h3>
                                      ${ERREUR }
									  <hr>
                                      <div class="form-group">
                                          <label for="exampleInputPassword1">Login :</label>
                                          <input type="text"  name="login" class="form-control" id="exampleInputPassword1" placeholder="Entrer votre Login" required>
                                      </div>
									   <div class="form-group">
                                          <label for="exampleInputPassword1">Password :</label>
                                          <input type="password"  name="password" class="form-control" id="exampleInputPassword1" placeholder="Entrer votre Password" required>
                                      </div>
									   <div class="text-right">
                                           <button type="submit"  name="gerer" value="Se Connecter" class="btn btn-info">Se Connecter</button>
									   </div>
                                  </form> 
					...
					<div class="col-md-4">
						<form role="form" method="post" action="ServletSite">
										<h3><font color="#00aeef">Inscription</font></h3>
										 ${MSG }
										<h5>Inscrivez-vous gratuitement</h5>
										<hr>
									   <div class="form-group">
                                          <label for="exampleInputEmail1">Nom</label>
                                          <input type="text" class="form-control" name="nom" id="exampleInputEmail1" placeholder="Enter Nom" required>
                                      </div>
                                      <div class="form-group">
                                          <label for="exampleInputPassword1">Prénom</label>
                                          <input type="text" class="form-control"  name="prenom" id="exampleInputPassword1" placeholder="Enter Prénom" required>
                                      </div>
									  <div class="form-group">
                                          <label for="exampleInputPassword1">N°GSM</label>
                                          <input type="number" class="form-control"  name="tel" id="exampleInputPassword1" placeholder="Enter N° Téléphone" required>
                                      </div>
                                      <div class="form-group">
                                          <label for="exampleInputPassword1">Email</label>
                                          <input type="email" class="form-control" name="mail" id="exampleInputPassword1" placeholder="Enter email"required>
                                      </div>
									  <div class="form-group">
                                          <label for="exampleInputPassword1">Login</label>
                                          <input type="text" class="form-control"  name="login" id="exampleInputPassword1" placeholder="Enter Login"required>
                                      </div>
									  <div class="form-group">
                                          <label for="exampleInputPassword1">Password</label>
									   ...
									   <div class="text-right">
                                           <button type="submit"  name="gerer" value="inscrire" class="btn btn-info">S'inscrire</button>
									   </div>
                                  </form> 
					</div>
                </div>
